...
(function exposeSiteData(global) {
  const company = {
    ...
    seo: {
      ...
      title:
        'Гаражи и навесы под ключ во Владимире и области | Металл Монтаж 33',
      description:
    ...
    garageProjects: [
      ...
      },
      {
        ...
        specs: [
          'Рама 80×80×3',
          'Ферма 60×60×3',
          'Стена сэндвич панели 100 мм',
          'Кровля сэндвич панели 100 мм',
          'Ворота «Алютех»',
        ],
      ...
      {
        title: 'Гараж из сэндвич панелей',
        size: '8000 × 8000 × 2400 мм',
        price: 1460000,
        specs: [
          'Рама 80×80×3',
          'Ферма 80×80×3',
          'Стеновая сэндвич панели 100 мм',
          'Кровля сэндвич панели 100 мм',
          'Ворота «Алютех»',
        ],
    ...
    composition: [
      {
        ...
        text: 'Профильная труба 80×80 мм, антикоррозийное покрытие',
        img: './assets/composition-frame.webp',
      },
      {
        title: 'Сэндвич-панели',
        text: 'Стеновые и кровельные, толщина утеплителя 100 мм',
        img: './assets/composition-panels.webp',
      },
      {
        title: 'Секционные ворота',
        text: 'Автоматика или механика, высота 2,1—2,5 м',
    ...
    advantages: [
      ...
      },
      {
        ...
        value: 'По замеру',
        lines: ['Кратчайшие сроки после замера', 'и утверждения проекта.'],
      },
      {
        title: 'Долговечность',
        value: 'Сварка',
        lines: [
          'Металлокаркас со сварочным соединением.',
      ...
      },
      {
        title: 'Утеплитель',
        value: 'Минвата',
        lines: ['Опция минеральной ваты.', 'Также доступен пенопласт.'],
      },
      {
        title: 'Гарантия',
        value: '3 года',
      ...
      },
      {
        title: 'Эстетика',
        value: 'Цвет',
        lines: ['Размер, форма и цвет под задачу объекта.'],
      },
    ],
